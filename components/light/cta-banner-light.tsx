...
export function CtaBannerLight() {
  return (
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="absolute top-1/2 right-1/4 -translate-y-1/2 w-72 h-72 bg-primary/3 rounded-full blur-[100px]" />
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="#configurator"
            className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-all hover:gap-3 text-lg shadow-lg shadow-primary/20"
          >
            Configure & Price
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 px-8 py-4 border border-border text-foreground font-semibold rounded-lg hover:bg-secondary transition-colors text-lg"
          >
            Talk to an Expert
          </a>
        </div>
