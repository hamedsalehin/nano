...
export function ConfiguratorLight() {
...
`.trim()
  ...
  return (
    <section id="configurator" className="relative py-24 bg-secondary/40">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid lg:grid-cols-5 gap-6">
          {/* Config Form */}
          <div className="lg:col-span-3 bg-card rounded-2xl border border-border p-6 lg:p-8 shadow-sm">
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="flex-1 accent-[#0077cc]"
                  />
                  <div className="flex flex-col items-center">
                    <div className="flex items-center gap-3">
                      <button
                        onClick={() => setWidth(prev => Math.max(1, prev - 1))}
                        className="w-10 h-10 flex items-center justify-center bg-white border border-border rounded-lg text-muted-foreground hover:text-foreground hover:border-primary transition-all shadow-sm"
                        disabled={width <= 1}
                      >
                        <Minus className="w-3.5 h-3.5" />
                      </button>
                      <div className="w-24 h-10 flex items-center justify-center bg-secondary rounded-lg text-foreground font-mono font-bold text-sm border border-border">
                        {width} mod
                      </div>
                      <button
                ...
                <div className="mt-4 flex items-center gap-3">
                  <span className="text-xs text-muted-foreground font-mono uppercase tracking-tight font-medium">Cabinet Size:</span>
                  <div className="relative group">
                    <input
                      ...
                      className="w-32 h-10 bg-white border border-border rounded text-foreground font-mono text-sm text-center focus:border-primary outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none pr-8"
                    />
                  ...
                  <span className="text-xs text-muted-foreground font-mono font-medium">
                    ({widthIn}" screen) ≈ {widthFt} ft | {widthCm} cm
                  </span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-4 flex items-center gap-3">
                  ...
                  <span className="text-xs text-muted-foreground font-mono font-medium">
                    ({heightIn}" screen) ≈ {heightFt} ft | {heightCm} cm
                  </span>
                </div>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full h-10 px-3 bg-white border border-border rounded-lg text-foreground text-sm focus:border-primary focus:outline-none transition-colors"
                >
                ...
                <div className="flex gap-2">
                  {environmentOptions.map((env) => (
                    <button
                      ...
                      className={`flex-1 h-10 text-sm font-semibold rounded-lg transition-all ${environment === env.value
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  {cabinetOptions.map((cab) => (
                    <button
                      ...
                      className={`h-10 text-xs font-semibold rounded-lg transition-all px-2 ${cabinet === cab.value
                        ? "bg-primary text-primary-foreground shadow-md shadow-primary/20"
                        : "bg-white border border-border text-muted-foreground hover:text-foreground"
                        }`}
                    >
            ...
            <div className="mt-8 flex items-center justify-center">
              <div className="relative">
                <div
                  className="border-2 border-primary/30 rounded-lg bg-primary/5 flex items-center justify-center transition-all duration-300"
                  style={{
          ...
          {/* Price Summary */}
          <div className="lg:col-span-2 bg-card rounded-2xl border border-border p-6 lg:p-8 flex flex-col justify-between shadow-sm">
            <div>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex justify-between items-center py-2 px-3 bg-primary/5 border border-primary/10 rounded-lg -mx-1 shadow-sm">
                  <span className="text-primary text-[11px] font-bold uppercase tracking-wider">Final Cabinet Size</span>
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="flex items-center justify-center gap-2 w-full py-3 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-colors shadow-md shadow-primary/20"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 w-full py-3 bg-white text-foreground font-semibold rounded-md border border-border hover:border-primary transition-all shadow-sm"
              >
              ...
              <button
                onClick={reset}
                className="flex items-center justify-center gap-2 w-full py-3 border border-border text-muted-foreground font-semibold rounded-lg hover:bg-secondary hover:text-foreground transition-colors"
              >
